...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/surajislam/ANIE-2")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support and contact information - Provide your own support channels
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ABZ_ANOKHI")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+Cme_kzzkIuAxMDJl")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/2b738aa6b01962f286738.jpg"
)
PING_VID_URL = getenv(
